 ...
 * @author Joshua ellis
 */
class PoisonCloud extends PlayerCard
{
	public function new(owner:PlayerCharacter) 
	{
		...
		windupTime = 1.0;
		addItem(windupAnimation = new Animation(this, AssetPaths.castSpell_35__png, Library.damageColors.get(DamageTypes.poison), 192, 192, 35, 1));
		chargeTime = 2.0;
	}
