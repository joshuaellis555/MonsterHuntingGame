 ...
 * @author Joshua ellis
 */
class IceBlast extends PlayerCard
{
	public function new(owner:PlayerCharacter) 
	{
		super(owner, [DamageTypes.cold]);
		name = "Ice Blast";
		family = CardFamily.Blue;
		cardType.spell(true);
		cost = new Resources([0, 0, 3]);
		windupTime = 1.0;
		addItem(windupAnimation = new Animation(this, AssetPaths.castSpell_35__png, Library.damageColors.get(DamageTypes.cold), 192, 192, 35, 1));
		chargeTime = 2.0;
	}
