 ...
 * @author Joshua ellis
 */
class RhinoBash extends MonsterCard
{
	...
	{
		damage(target, if (this.owner.distanced()) 7 else 2, 6);
		owner.effects.addGuard(Std.int(Math.max(4, owner.effects.maxGuard() + 2)), 10);
